(function (window) {
    ...
    var circleProgress = function (options) {
        ...
        options.color = options.color || 'rgb(255, 253, 220)';
        options.bgColor = options.bgColor || 'rgb(151, 53, 52)';
        options.textColor = options.textColor || '#fff';
    ...
    var drawCircleProgress = function (options) {
        ...
        ctx.fillText('' + current.toFixed(options.toFixed) + '%', x, 140);
        ctx.restore();
    };
